# worker/services/kafka_producer.py
...
class ResultsProducer:
    """Publishes processed tiles back to master"""
    ...
    def publish_result(self, tile_id, processed_image_base64, x, y, job_id):
        """
        Publish processed tile back to master
        
        Args:
            tile_id: Original tile ID
            processed_image_base64: Processed image data
